...
/////////////////////// TOKEN FUNCTIONS ///////////////////////
    ...
    function TC() {
        ...
        totalSupply = 200000000000;                                                   // 100% - 100m
        TripCoinTeamSupply = 10000000000;                                              // 10%
        ReserveSupply = 30000000000;                                                // 30% 
        incentivisingEffortsSupply = 10000000000;                                    // 10% 
        presaleSupply = 25000000000;                                                // 25%
        icoSupply = 25000000000;                                                    // 25%
